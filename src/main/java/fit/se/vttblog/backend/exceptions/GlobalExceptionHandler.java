package fit.se.vttblog.backend.exceptions;
...
public class GlobalExceptionHandler {
   ...
   public ModelAndView handleNoResultException(NoResourceFoundException e) {
      logger.log(Level.SEVERE, "No result error: ", e);
